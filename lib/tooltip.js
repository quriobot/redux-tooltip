  ...
  _createClass(Tooltip, [{
    ...
    value: function children() {
      ...
      if (typeof content === 'string') {
        content = (0, _htmlReactParser2.default)(content);
      }
    ...
    value: function render() {
      ...
      var opacity = origin && show ? 1 : 0;
      var offset = show ? this.state.offset : _extends({}, this.state.offset, { left: 0, top: 0 });
      var style = {
        base: _extends({}, styles.base, themes.simple.base, { visibility: visibility, opacity: opacity }, offset),
      ...
      style.shadow = _extends({}, style.content, { visibility: 'hidden', position: 'absolute', maxWidth: maxWidth });
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('span', { ref: function ref(el) {
                return _this3.border = el;
              }, style: style.border, key: 'b-' + place })
          )
        ),
        _react2.default.createElement('div', {
          ref: function ref(el) {
            return _this3.shadow = el;
          },
          style: style.shadow,
          id: id + '-shadow',
