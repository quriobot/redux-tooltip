...
var Origin = function (_Component) {
  ...
  _createClass(Origin, [{
    ...
    value: function render() {
      ...
      var props = (0, _blacklist2.default)(this.props, 'name', 'content', 'place', 'maxWidth', 'tagName', 'delay', 'delayOn', 'dispatch', 'onTimeout', 'onHover', 'onLeave');
      ...
      if (typeof WrappedComponent == 'function') {
        return _react2.default.createElement(
          WrappedComponent,
          { onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave, ref: function ref(el) {
      ...
      return _react2.default.createElement(this.props.tagName, _extends({}, props, { ref: this.wrapper
      }));
    }
  }], [{
    key: 'wrapBy',
