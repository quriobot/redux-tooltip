...
var SHOW_PROPS = ['origin', 'el', 'place', 'content', 'maxWidth'];
...
var handlers = (_handlers = {}, _defineProperty(_handlers, _actions.SHOW, function (state, action) {
  ...
  return _extends({}, state, { timeout: null });
}), _defineProperty(_handlers, _actions.MAX_WIDTH, function (state) {
  return _extends({}, state, { maxWidth: action.payload });
}), _handlers);
